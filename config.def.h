...
static char font[256] = "DejaVu Sans Mono:pixelsize=14:antialias=true:autohint=true";
static char font2[256] = "Noto Color Emoji:pixelsize=12:antialias=true:autohint=true";
